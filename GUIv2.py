...
class FirstWindow(Screen):
    ...
    urls=[]
    titledict={}
    thumbnail_url=StringProperty('https://media.cdnandroid.com/item_images/773030/imagen-black-wallpaper-0big.jpg')
    def suggest(self):
    ...
    def showtitle(self):
        ...
        title_text=f'You choose to download: {my_video.title}'
        ...
        downloaded.add_widget(titlevideo)
